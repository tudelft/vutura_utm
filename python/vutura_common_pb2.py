...
_AVOIDANCEVELOCITY = _descriptor.Descriptor(
  name='AvoidanceVelocity',
  full_name='AvoidanceVelocity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='avoid', full_name='AvoidanceVelocity.avoid', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vx', full_name='AvoidanceVelocity.vx', index=1,
      number=2, type=17, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='vy', full_name='AvoidanceVelocity.vy', index=2,
      number=3, type=17, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='vz', full_name='AvoidanceVelocity.vz', index=3,
      number=4, type=17, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['AvoidanceVelocity'] = _AVOIDANCEVELOCITY
...
AvoidanceVelocity = _reflection.GeneratedProtocolMessageType('AvoidanceVelocity', (_message.Message,), dict(
  DESCRIPTOR = _AVOIDANCEVELOCITY,
  __module__ = 'vutura_common_pb2'
  # @@protoc_insertion_point(class_scope:AvoidanceVelocity)
  ))
_sym_db.RegisterMessage(AvoidanceVelocity)
